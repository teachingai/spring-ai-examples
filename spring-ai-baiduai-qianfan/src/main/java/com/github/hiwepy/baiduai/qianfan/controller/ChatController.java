package com.github.hiwepy.baiduai.qianfan.controller;
...
public class ChatController {
    ...
    private final BaiduAiQianfanChatClient chatClient;

    @Autowired
    public ChatController(BaiduAiQianfanChatClient chatClient) {
