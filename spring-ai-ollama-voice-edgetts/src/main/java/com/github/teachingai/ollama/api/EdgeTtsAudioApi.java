...
public class EdgeTtsAudioApi {
     ...
     */
    public EdgeTtsAudioApi(String baseUrl,
    ...
    public record SpeechRequest(
        ...
        public enum Voice {
            ...
            af_ZA_AdriNeural("af-ZA-AdriNeural", "Female"),
            af_ZA_WillemNeural("af-ZA-WillemNeural", "Male"),
            am_ET_AmehaNeural("am-ET-AmehaNeural", "Male"),
            am_ET_MekdesNeural("am-ET-MekdesNeural", "Female"),
...
*/
            ...
            private Voice(String name, String gender) {
                this.name = name;
                this.gender = gender;
            }
