...
import com.github.teachingai.ollama.metadata.audio.EdgeTtsAudioSpeechMetadata;
...
public class Speech implements ModelResult<InputStream> {
    ...
    private EdgeTtsAudioSpeechMetadata speechMetadata;
    ...
    @Override
    public EdgeTtsAudioSpeechMetadata getMetadata() {
        return speechMetadata != null ? speechMetadata : EdgeTtsAudioSpeechMetadata.NULL;
    }

    public Speech withSpeechMetadata(@Nullable EdgeTtsAudioSpeechMetadata speechMetadata) {
