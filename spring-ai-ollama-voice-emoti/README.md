...
> 基于 Spring Boot 3.x 、Spring AI 和 [Ollama](https://ollama.com/)、[EmotiVoice](https://github.com/netease-youdao/EmotiVoice) 的 Text-To-Speech (TTS) 功能示例。
...
从2024年的docker镜像版本开始，通过 `http://localhost:8000/` 可以使用类 `OpenAI TTS` 的API功能。
