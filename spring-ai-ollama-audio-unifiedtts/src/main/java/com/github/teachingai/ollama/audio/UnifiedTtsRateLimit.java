...
public class UnifiedTtsRateLimit implements RateLimit {
    ...
    public UnifiedTtsRateLimit(Long requestsLimit, Long requestsRemaining, Duration requestsReset, Long tokensLimit,
