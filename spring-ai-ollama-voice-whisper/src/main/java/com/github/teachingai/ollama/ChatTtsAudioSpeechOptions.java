...
public class ChatTtsAudioSpeechOptions implements ModelOptions {
     ...
     */
    @JsonProperty("voice")
    private ChatTtsAudioApi.SpeechRequest.Voice voice;
    ...
    private ChatTtsAudioApi.SpeechRequest.AudioResponseFormat responseFormat;
    ...
    public static class Builder {
        ...
        public Builder withVoice(ChatTtsAudioApi.SpeechRequest.Voice voice) {
            options.voice = voice;
            return this;
        }

        public Builder withResponseFormat(ChatTtsAudioApi.SpeechRequest.AudioResponseFormat responseFormat) {
    ...
    public ChatTtsAudioApi.SpeechRequest.Voice getVoice() {
        return voice;
    }

    public ChatTtsAudioApi.SpeechRequest.AudioResponseFormat getResponseFormat() {
    ...
    public void setVoice(ChatTtsAudioApi.SpeechRequest.Voice voice) {
        this.voice = voice;
    }

    public void setResponseFormat(ChatTtsAudioApi.SpeechRequest.AudioResponseFormat responseFormat) {
    ...
    public boolean equals(Object obj) {
        ...
        ChatTtsAudioSpeechOptions other = (ChatTtsAudioSpeechOptions) obj;
        if (model == null) {
            if (other.model != null) {
                return false;
            }
